...
//purchase.thank-you.block.render only renders on thank you page

const orderDetailsBlock = reactExtension("customer-account.order-status.block.render", () => <ProductReview />);
export { orderDetailsBlock };
//customer-account.order-status.block.render only renders on order status page when customers revisit their purchase.
